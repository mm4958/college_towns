...
df = pd.read_csv('/home/mm4958/openalex/custom_pipeline/results/custom_final_raw.csv')
# -------------------------
# Initial stats
# -------------------------
#Drop duplicate affiliations in terms of start and end date and author
unique_affiliation = df.drop_duplicates(
...
desc.to_csv("/home/mm4958/openalex/custom_pipeline/results/df_raw_sum_stats.csv")
# -------------------------
# Affiliation 
# -------------------------
...
remaining_overlap.to_csv('/home/mm4958/openalex/custom_pipeline/results/remaining_partial_overlaps_all_perfect_overlaps.csv', index=False)
# -------------------------
...
df_merged.to_csv('/home/mm4958/openalex/custom_pipeline/results/custom_cleaned_final.csv', index=False)
